...
import { extensionSectionsTemplates } from '~/templates/extension-sections-template';
                      ...
                      ${this.renderStyle === 'focused'
                        ...
                        : html`
                            ...
                            ${this.allowAuthentication === 'true'
                              ? securitySchemeTemplate.call(this, this.allowTry)
                              : ''}
                            ...
                            ${this.showInfo === 'true'
                              ? extensionSectionsTemplates.call(this)
                              : ''}
                          `}
                    </div>
                  `}`}
